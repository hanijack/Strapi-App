  ...
  return (
    <div className="flex flex-col relative mt-8">
      ...
      <div className="flex flex-col px-6 md:px-16 pb-12 xl:px-24 w-10/12 self-center lg:-mt-24 shadow-xl bg-white z-30 max-w-6xl 2xl:mx-auto">
        <h1 className="font-bold text-2xl mt-6 text-center w-10/12 text-primary self-center bg-slate-200  p-4 capitalize">{data.title}</h1>
        <div className="relative w-10/12 h-[600px] flex justify-center mt-6 text-center self-center">
          <StrapiImage src={data.image2.url} fill className=" object-fill  md:object-fill" alt={`${data.title}2`}/>
        </div>
        <p className="text-secondary font-[300] mb-6 w-10/12 text-start self-center mt-6">{data.Text} </p>
      </div>
