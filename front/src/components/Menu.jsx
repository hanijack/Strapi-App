    ...
    <div>
        ...
        {open ? (
            <ul className="absolute bg-white text-[#b58c4d] right-0 top-20 h-[400px] w-full flex flex-col justify-evenly items-center text-lg z-50 transition-all ease-in-out duration-300  inset-shadow-md inset-shadow-indigo-500 ">
                ...
                <li className="hover:bg-[#b58c4d] w-full hover:text-white hover:cursor-pointer flex-1 flex items-center justify-center shadow-md" onClick={()=>setOpen(false)}><Link href="/about" >About</Link></li>
                <li className="hover:bg-[#b58c4d] w-full hover:text-white hover:cursor-pointer flex-1 flex items-center justify-center shadow-md" onClick={()=>setOpen(false)}><Link href="/contact" >Contact</Link></li>
                <li className="hover:bg-[#b58c4d] w-full hover:text-white hover:cursor-pointer flex-1 flex items-center justify-center shadow-md" onClick={()=>setOpen(false)}><Link href="/projects" >projects</Link></li>
            </ul>
